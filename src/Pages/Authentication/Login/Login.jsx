...
const Login = () => {
    return (
        ...
        <div className="hero min-h-screen bg-[url(/loginPageBg.png)]">
            ...
            <div className="card  w-full max-w-md py-8 shadow-2xl">
                ...
                <div className='card-body'>
                    ...
                    <div class="flex items-center justify-center gap-3 sm:gap-x-5 mt-2">
                ...
                <h3 className='text-center'>Not Have Account?  <Link to="/registration" className='text-white underline'>SignUp Now</Link></h3>
            </div>
